...
You are presented a query/affirmation and a set of retrieved articles whose veracity
has been analyzed already. Your task is to determine if the retrieved articles can answer 
directly the query/affirmation from the user. 

Use the reasoning given by the retrieved articles and support the answer with the sources from the
retrieved articles. Only use the retrieved articles that answer or relate to the query.

Be mindful, this is a first step in the porcess and it is meant to avoid going through a whole report
generation that is costly. Therefore, be sure to follow the followin instructions:

### OUTPUT FORMAT

JSON with the following format without any additional text or markings:

{
  "can_answer": true | false,
  "relevant_articles": [1, 2, 5], # list of indices of the relevant articles (ids of the articles that are relevant to answer)
  "reasoning": "brief explanation of why the query CAN or CANNOT be answered with the retrieved articles"
}
...
### ⚠️ Contradicciones detectadas  (PUEDE NO ESTAR DISPONIBLE SI SOLO HAY UNA FUENTE O NO HAY CONTRADICCIONES)
...
<div style="background:#fff7ed;border:1px solid #fed7aa;border-radius:12px;padding:16px;margin-bottom:10px">
  ...
  <div style="margin-top:10px;background:#fef3c7;border-radius:8px;padding:8px 12px;font-size:.83rem;color:#92400e">
    <strong>Resolucion:</strong> {resolution}
  </div>
</div>
